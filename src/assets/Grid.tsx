export const Grid = () => {
  return (
    <svg fill="#000000" width="100%" height="100%" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M20,13 L16,13 L16,20 L20,20 L20,13 Z M20,11 L20,4 L16,4 L16,11 L20,11 Z M4,13 L4,20 L8,20 L8,13 L4,13 Z M4,11 L8,11 L8,4 L4,4 L4,11 Z M14,11 L14,4 L10,4 L10,11 L14,11 Z M14,13 L10,13 L10,20 L14,20 L14,13 Z M22,4 L22,20 C22,21.1045695 21.1045695,22 20,22 L4,22 C2.8954305,22 2,21.1045695 2,20 L2,4 C2,2.8954305 2.8954305,2 4,2 L20,2 C21.1045695,2 22,2.8954305 22,4 Z"/>
    </svg>
  );
};